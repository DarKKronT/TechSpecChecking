...
{
    public sealed class FourthSectionSubsubsectionPresenceAnalisator : ISectionAnalisator
    {
        ...
        public string Name => "Fourth section subsubsection presence analisator";
